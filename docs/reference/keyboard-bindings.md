...
| `Ctrl+Tab` | Switch focus to the preview pane (split mode) |
...
When `Ctrl+Tab` has moved focus to the preview pane in split view, these keys scroll it:
...
| `Ctrl+Tab` | Return focus to the editor |
